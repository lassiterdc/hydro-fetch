...
fldr_mrms_at_gages = fldr_data + "mrms_zarr_preciprate_fullres_yearlyfiles_atgages/"
...
f_ref_csvs_fullres = fldr_data + "stage_iv_csv_preciprate_fullres_yearlyfiles_atgages/*.csv"
