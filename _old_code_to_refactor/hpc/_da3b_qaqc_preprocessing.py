...
#%% end work
fldr_out = str(sys.argv[1]) # ${assar_dirs[out_fullres_dailyfiles_consolidated]} # "/scratch/dcl3nd/highres-radar-rainfall-processing/out_fullres_dailyfiles_consolidated/"
grouping_index = int(sys.argv[2])-1 # subtracting 1 since the slurm task id is 1-indexed
fl_nc_qaqc_out_all = fldr_out + "_qaqc_of_resampled_data.nc"
...
f_pattern = fldr_out + "_qaqc_of_resampled_data_{}_{}.nc"
