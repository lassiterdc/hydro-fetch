...
assar_dirs[out_fullres_dailyfiles]=${assar_dirs[scratch_repo]}"_scratch/mrms_zarr_preciprate_fullres_dailyfiles/"
...
assar_dirs[out_fullres_yearly_atgages]=${assar_dirs[hpc_data]}"mrms_zarr_preciprate_fullres_yearlyfiles_atgages/"
